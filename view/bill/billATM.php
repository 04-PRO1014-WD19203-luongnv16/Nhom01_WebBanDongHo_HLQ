                    ...
                    <tr data-id="<?=$i?>">
                        ...
                        <td>
                            <div class="quantity-controls">
                                <input type="number" class="quantity-input" value="<?=$cart['quantity']?>" min="1" data-id="<?=$i?>" readonly>
                            </div>
                        </td>
...
<div class="momo_atm">
    <form class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="trangchu.php?act=xulythanhtoanmomo_atm">
        ...
        <div class="actions">
            <input class="datthem" type="submit" value="Thanh toan Momo ATM" name="btn_buyMomoATM" >  
